    ...
    void sendsZyteExtractionRequest() {
        ...
        server.expect(requestTo(ENDPOINT))
                ...
                .andExpect(jsonPath("$.actions[0].selector.value")
                        .value("[data-test-id=\"dynamic-filter-instance-transfers_count\"]"))
                .andExpect(jsonPath("$.actions[1].action").value("waitForSelector"))
                .andExpect(jsonPath("$.actions[1].selector.value").value("[data-test-id=\"set-filter-row-0\"]"))
                .andExpect(jsonPath("$.actions[2].action").value("waitForSelector"))
                .andExpect(jsonPath("$.actions[2].selector.value").value("[data-test-id=\"search-results-items-list\"]"))
                .andExpect(jsonPath("$.actions[3].action").value("evaluate"))
                .andExpect(jsonPath("$.actions[3].source").isNotEmpty())
                .andExpect(jsonPath("$.actions[4].action").value("click"))
                .andExpect(jsonPath("$.actions[4].selector.value")
                        .value("[data-test-id=\"set-filter-row-0\"] input[type=\"checkbox\"]"))
                .andExpect(jsonPath("$.actions[5].action").value("evaluate"))
                .andExpect(jsonPath("$.actions[5].source").isNotEmpty())
                .andExpect(jsonPath("$.actions[6].action").value("waitForSelector"))
                .andExpect(jsonPath("$.actions[6].selector.value").value("[data-test-id=\"search-results-items-list\"]"))
